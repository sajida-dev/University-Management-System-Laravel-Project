@extends('layouts.app')
@section('page-name', 'Edit Other Details')
@section('admin-main')
            ...
            <div id="panel-12" class="card">
                ...
                <div class="card-body show">
                    <div class="panel-content">
                        <form method="post" action="{{ route('admission.other-detail.update', $otherDetail->id) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select name="Transport" id="Transport" class="form-control select2" required>
                                        ...
                                        @if ($otherDetail->transport_required)
                                            <option selected value="1">Yes</option>
                                            <option value="0">No</option>
                                        @else
                                            <option value="1">Yes</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select name="Hostel" id="Hostel" class="form-control select2" required>
                                        ...
                                        @if ($otherDetail->is_hostel_required)
                                            <option selected value="1">Yes</option>
                                            <option value="0">No</option>
                                        @else
                                            <option value="1">Yes</option>
