@extends('layouts.app')
@section('page-name', 'Add Disability Details')
@section('admin-main')
            ...
            <div id="panel-12" class="card">
                ...
                <div class="card-body show">
                    <div class="panel-content">
                        <form method="post" action="{{ route('admission.disability-detail.store') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select value="{{ old('DisabilityStatus') }}" name="DisabilityStatus"
                                        id="DisabilityStatus" class="form-control select2">
                            ...
                            <div class="row mb-3 disability">
                                ...
                                <div class="col-sm-8">
                                    <select value="{{ old('DisabilityType') }}" name="DisabilityType" id="DisabilityType"
                                        ...
                                        <option selected value="">Choose Disability Type</option>
                                        ...
                                        <option value="Severe Emotional Disturbance (SED)">Severe Emotional Disturbance
                                            (SED)</option>
                            ...
                            <div class="row mb-3 disability">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="DisabilityAccommodation" id="DisabilityAccommodation"
                                        class="form-control" value="{{ old('DisabilityAccommodation') }}">
