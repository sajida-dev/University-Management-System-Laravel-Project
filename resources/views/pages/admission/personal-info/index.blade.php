@extends('layouts.app')
@section('page-name', 'Personal Details')
@section('admin-main')
            ...
            <div id="panel-12" class="card">
                ...
                <div class="card-body  show">
                    <div class="panel-content">
                        ...
                        <form method="post" action="{{ route('admission.profile-detail.store') }}"
                            ...
                            <div class="mb-12 text-center">
                                {{-- <img src="https://admissions.uoel.edu.pk/images/1720875014.jpg"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <x-input-error class="mt-2 @error('profile') has-error @enderror" :messages="$errors->get('profile')" />
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select name="blood_group_id" value="{{ old('blood_group_id') }}" id="blood_group_id"
                                        ...
                                        @foreach ($bloodGroups as $bg)
                                            <option value="{{ $bg->id }}"
                                                {{ old('blood_group_id') == $bg->id ? 'selected' : '' }}>{{ $bg->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <x-input-error class="mt-2 @error('blood_group_id') has-error @enderror"
                                        :messages="$errors->get('blood_group_id')" />
                                </div>
                            </div>
                            <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select name="marital_status" value="{{ old('marital_status') }}" id="marital_status"
                                ...
                                <option value="0" {{ old('marital_status') == '0' ? 'selected' : '' }}>Un
                                    Married
                                </option>
                            </select>
                            <x-input-error class="mt-2 @error('marital_status') has-error @enderror" :messages="$errors->get('marital_status')" />
                        </div>
                        <label for="date_of_birth" class="col-sm-2 col-form-label">Date of Birth: <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-4">
                            <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                required="required" value="{{ old('date_of_birth') }}">
                            <x-input-error class="mt-2 @error('date_of_birth') has-error @enderror" :messages="$errors->get('date_of_birth')" />
                        </div>
                    </div>
                    <div class="row mb-3">
...
@enderror" />
                        ...
                        <div class="col-sm-4">
                            <select type="text" class="form-control num" name="is_disability" autocomplete="off"
                                ...
                                <option value="1" {{ old('is_disability') == '1' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="0" {{ old('is_disability') == '0' ? 'selected' : '' }}>No
                                </option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="father_name" id="father_name"
                                value="{{ old('father_name') }}" required maxlength="100" minlength="2">
...
@enderror" />
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control num" name="father_cnic" id="father_cnic"
                                required="required" value="{{ old('father_cnic') }}" maxlength="13" minlength="13">
                    ...
                    <div class="row mb-3 ">
                        ...
                        <div class="col-sm-4">
                            <select name="is_father_alive" value="{{ old('is_father_alive') }}" id="is_father_alive"
                                class="form-control select2">
                                <option value="1" {{ old('is_father_alive') == '1' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="0" {{ old('is_father_alive') == '1' ? 'selected' : '' }}>No
                                </option>
                            </select>
...
@enderror" />
                        ...
                        <div class="col-sm-4 father">
                            <input type="text" class="form-control num" name="father_phone_number"
                                id="father_phone_number" value=" {{ old('father_phone_number') }} " required
                                maxlength="11">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <select name="is_old_student" onchange="handleOldStudent()" id="OldStudent"
                                ...
                                <option value="1" {{ old('is_old_student') == '1' ? 'selected' : '' }}>Yes
                                </option>
                                <option value="0" {{ old('is_old_student') == '0' ? 'selected' : '' }}>No
                                </option>
                            </select>
