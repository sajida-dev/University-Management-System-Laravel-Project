    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-12" class="card">
                ...
                <form action="{{ route('faculty.final.store') }}" method="post">@csrf
                        ...
                        if (students.length > 0) {
                            students.forEach(function(student) {
                                var row = '<tr>' +
                                    ...
                                    '</td>' +
                                    '<td><input class="form-control" type="text" name="practical_marks[]">' +
                                    '<input type="hidden" name="student_id[]" value="' + student
                                    .id +
                                    '"></td>' +
                                    '<td><input class="form-control" type="text" name="sessional_marks[]"></td>' +
                                    '<td><input class="form-control" type="text" name="final_marks[]"></td>' +
                                    '</tr>';
