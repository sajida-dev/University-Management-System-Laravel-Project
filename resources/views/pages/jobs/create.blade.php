            ...
            <div id="panel-12" class="card">
                ...
                <div class="card-body show">
                    <div class="panel-content">
                        <form method="post" action="{{ route('jobs.store') }}" enctype="multipart/form-data">@csrf
                            <div class="row mb-2 ">
                                ...
                                <div class="col-sm-4 ">
                                    <input type="number" class="form-control" name="vacancies"
                                        value="{{ old('vacancies') }}" id="vacancies" required>
                            ...
                            <div class="row mb-2 ">
                                <label for="salaryFrom" class="col-sm-2 col-form-label"> Min Starting: <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-4 ">
                                    <input type="text" value="{{ old('salaryFrom') }}" class="form-control"
                                ...
                                <label for="salaryTo" class="col-sm-2 col-form-label"> Maximum Salary#: <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-4 ">
                                    <input type="number" class="form-control" name="salaryTo" value="{{ old('salaryTo') }}"
                            ...
                            <div class="row mb-2 ">
                                <label for="description" class="col-sm-2 col-form-label"> Description: <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10 ">
                                    <textarea class="form-control" rows="5" name="description" id="description" maxlength="100" minlength="2">{{ old('description') }}</textarea>
