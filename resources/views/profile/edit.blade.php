                                ...
                                <div class="col-sm-4">
                                    <select name="blood_group_id" value="{{ old('blood_group_id') }}" id="blood_group_id"
                                        ...
                                        @foreach ($bloodGroups as $bg)
                                            <option value="{{ $bg->id }}"
                                                @if ($bg->id == $user->personalInfo->blood_group_id) {{ 'selected' }} @endif
                        ...
                        <div class="col-sm-4">
                            <select name="marital_status" value="{{ old('marital_status') }}" id="marital_status"
                                ...
                                <option value="1" {{ old('marital_status') == '1' ? 'selected' : '' }}
                                    @if ('1' == $user->personalInfo->marital_status) {{ 'selected' }} @endif>
                                    Married
                                </option>
                                <option value="0" {{ old('marital_status') == '0' ? 'selected' : '' }}
                                    @if ('0' == $user->personalInfo->marital_status) {{ 'selected' }} @endif>Un
                                    Married
                                </option>
                            </select>
...
@enderror" />
                        ...
                        <div class="col-sm-4">
                            <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                required="required" value="{{ $user->personalInfo->date_of_birth }}">
                        ...
                        <div class="col-sm-4">
                            <select name="relgion_id" value="{{ old('relgion_id') }}" id="relgion_id"
                                ...
                                @foreach ($religions as $r)
                                    <option value="{{ $r->id }}"
                                        @if ($r->id == $user->personalInfo->relgion_id) {{ 'selected' }} @endif
                        ...
                        <div class="col-sm-4">
                            <select name="gender_id" value="{{ old('gender_id') }}" id="gender_id"
                                ...
                                @foreach ($genders as $g)
                                    <option value="{{ $g->id }}"
                                        @if ($g->id == $user->personalInfo->gender_id) {{ 'selected' }} @endif
                        ...
                        <div class="col-sm-4">
                            <select type="text" class="form-control num" name="is_disability" autocomplete="off"
                                ...
                                <option value="1" {{ old('is_disability') == '1' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_disability == '1') {{ 'selected' }} @endif>Yes
                                </option>
                                <option value="0" {{ old('is_disability') == '0' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_disability == '0') {{ 'selected' }} @endif>No
                                </option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="father_name" id="father_name"
                                value="{{ $user->personalInfo->father_name }}" required maxlength="100" minlength="2">
...
@enderror" />
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control num" name="father_cnic" id="father_cnic"
                                required="required" value="{{ $user->personalInfo->father_cnic }}" maxlength="13"
                                minlength="13">
                        ...
                        <div class="col-sm-4">
                            <select name="is_father_alive" value="{{ old('is_father_alive') }}" id="is_father_alive"
                                ...
                                <option value="1" {{ old('is_father_alive') == '1' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_father_alive == '1') {{ 'selected' }} @endif>Yes
                                </option>
                                <option value="0" {{ old('is_father_alive') == '1' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_father_alive == '0') {{ 'selected' }} @endif>No
                                </option>
                            </select>
...
@enderror" />
                        ...
                        <div class="col-sm-4 father">
                            <input type="text" class="form-control num" name="father_phone_number"
                                id="father_phone_number" value=" {{ $user->personalInfo->father_phone_number }} "
                        ...
                        <div class="col-sm-4">
                            <select name="is_old_student" onchange="handleOldStudent()" id="OldStudent"
                                ...
                                <option value="1" {{ old('is_old_student') == '1' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_old_student == '1') {{ 'selected' }} @endif>Yes
                                </option>
                                <option value="2" {{ old('is_old_student') == '1' ? 'selected' : '' }}
                                    @if ($user->personalInfo->is_old_student == '0') {{ 'selected' }} @endif>No
                                </option>
                            </select>
...
@enderror" />
                        ...
                        <div class="col-sm-4 old-student-registration" style="display: none;">
                            <input type="text" class="form-control" name="registration_no" id="registration_no"
                                value="{{ $user->personalInfo->registration_no }}">
